                  ...
                  child: Padding(
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        ...
                        try {
                          var docid1 = FirebaseFirestore.instance
                              .collection("Gathering")
                              .doc(name)
                              .collection("GatheringPost")
                              .doc();

                          var docid2 = FirebaseFirestore.instance
                              .collection("Gathering")
                              .doc(name)
                              .collection("GatheringPost")
                              .doc(docid1.id)
                          ...
                          clubpostinfo.add({
                            ...
                            "GatheringPostJoinList": docid2.id,
                            "Gathring_State": "off"
                          });
                          ...
                          FirebaseFirestore.instance
                              ...
                              .doc(name)
                              .update({
                            "Gathering_ID": FieldValue.arrayUnion([docid1.id]),
                          });
