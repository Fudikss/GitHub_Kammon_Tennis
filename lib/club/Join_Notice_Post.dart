...
class JoinNoticePost extends StatefulWidget {
  ...
  @override
  _JoinNoticePostState createState() =>
      _JoinNoticePostState(index, club_name, club_uid);
}
...
class _JoinNoticePostState extends State<JoinNoticePost> {
  ...
  _JoinNoticePostState(this.post_index, this.name, this.club_uid);
              ...
              StreamBuilder<DocumentSnapshot>(
                ...
                builder: (BuildContext context,
                  ...
                  if (snapshot.hasError) {
                    ...
                    key_number = data["NoticePost"][post_index]["KeyNumber"];

                    a = data["NoticePost"][post_index]["ClubPostTitle"];
                    b = data["NoticePost"][post_index]["ClubPostIntro"];
