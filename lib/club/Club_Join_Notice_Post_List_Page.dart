...
import '../home.dart';
// import 'Club_Join_Notice_Post.dart';
// import 'Notice_Post_1_2.dart';
import 'first_screen_1_0.dart';

class JoinNoticePostList extends StatefulWidget {
  final String prev_club_uid;
  final String prev_club_name;
  const JoinNoticePostList(
      {Key? key, required this.prev_club_uid, required this.prev_club_name})
      : super(key: key);

  @override
  _JoinNoticePostListState createState() =>
      _JoinNoticePostListState(prev_club_uid, prev_club_name);
}

class _JoinNoticePostListState extends State<JoinNoticePostList> {
  String club_uid = "";
  String club_name = "";
  ...
  _JoinNoticePostListState(this.club_uid, this.club_name);
