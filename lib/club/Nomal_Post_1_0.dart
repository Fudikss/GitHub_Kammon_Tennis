...
class NomalPost extends StatefulWidget {
  final int index;
  ...
  @override
  _NomalPostState createState() => _NomalPostState(
      index,
      club_uid,
      prev_post_title,
      prev_post_intro,
...
class _NomalPostState extends State<NomalPost> {
  String name = "";
  String club_uid = '';
  String post_title = "";
  String post_intro = "";
              ...
              ElevatedButton(
                ...
                onPressed: () {
                  ...
                  FirebaseFirestore.instance
                      ...
                      .doc("NomalPost")
                      .update(
                          {"NomalPost": FieldValue.arrayRemove(delete_data)});
...
//   @override
//   _NomalPostState createState() => _NomalPostState(index, club_uid,
...
//   _NomalPostState(this.post_index, this.club_uid, this.post_title,
