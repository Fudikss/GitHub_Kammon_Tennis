...
class MarketItemSellInfo extends StatefulWidget {
  ...
  @override
  _MarketItemSellInfoState createState() => _MarketItemSellInfoState(
      prev_nick_name,
      prev_title,
      prev_intro,
      prev_price,
...
class _MarketItemSellInfoState extends State<MarketItemSellInfo> {
  String nickname = "";
  String title = "";
  String intro = "";
  String price = "";
  ...
  List change_trade_list = ["판매중", "예약중", "거래완료"];

  String _select_value = "판매중";

  User user = FirebaseAuth.instance.currentUser!;

  int _selectedNaviIndex = 0;

  _MarketItemSellInfoState(
      this.nickname,
      this.title,
      this.intro,
      this.price,
